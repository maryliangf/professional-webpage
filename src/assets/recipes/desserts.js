const DESSERTS = [
  {
    ...
    instructions: [
      ...
      'Mix together wet ingredients in a large bowl. First mash bananas with a fork until smooth, leaving only a few chunky pieces. Then add remaining wet ingredients and mix well.',
      'Add in dry ingredients.',
      'Stir until combined and add optional toppings.',
      'Pour into loaf pan and smooth with spatula or spoon.',
      'Bake for 45 minutes or until banana bread is golden in color and toothpick/knife comes out clean.',
  ...
  },
  {
    ...
    info: 'Some desc here',
    thumbnail:
      'https://images.unsplash.com/photo-1535473895227-bdecb20fb157?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=634&q=80',
    author: 'maryliang',
    ingredients: ['banana', 'flour', 'oven'],
    wetIngredients: ['water', 'ocean water', 'river water', 'blessed water'],
