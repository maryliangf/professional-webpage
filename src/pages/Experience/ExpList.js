...
const ExpList = () => <div>
  <div id='Experience1'>
    <Exp
      ...
      text={<div>
        <p style={{ textAlign: 'justify' }}>A full-time 52-week rigorous dietetic internship with medical nutrition therapy concentration in a tertiary care, 720-bed teaching hospital.</p>
  ...
  <div id='Experience2'>
    <Exp
      ...
      text={<div>
        <p style={{ textAlign: 'justify' }}>First hospital-based therapeutic preventive food pantry in the country, distributing one million pounds of food every year and has served over one million people since 2001.</p>
        <ul style={{ textAlign: 'left' }}>
  ...
  <div id='Experience3'>
    <Exp
      ...
      text={<div>
        <p style={{ textAlign: 'justify' }}>Dietetic practicum at a 132-bed teaching hospital for Harvard Medical School. Spaulding Rehabilitational Hospital is  one of the largest rehabilitation facilities in the U.S., providing comprehensive rehabilitation treatment.</p>
        <ul style={{ textAlign: 'left' }}>
  ...
  <div id='Experience5'>
    <Exp
      ...
      text={<div>
        <p style={{ textAlign: 'justify' }}>The Greater Boston Food Bank (GBFB) works passionately to end hunger here by providing people from the area who are in need with the healthy food and resources they need.</p>
        <ul style={{ textAlign: 'left' }}>
          <li style={{ marginBottom: '0.7rem' }}>Aid in organizing, packaging, and loading foods for shipment to help end hunger by ensuring that communities in Eastern Massachusetts receive the timely and healthy food and resources they need.</li>
        </ul>
      </div>}
    />
  </div>
  <div id='Experience6'>
    <Exp
      ...
      text={<div>
        <p style={{ textAlign: 'justify' }}>BU offers one of the best campus dining services in the country, with three residence dining rooms with all-you-can-eat food service and the George Sherman Union Food Court which has 11 different restaurants.</p>
        <ul style={{ textAlign: 'left' }}>
