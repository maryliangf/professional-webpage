...
export const Prone = () => (
  <>
    ...
    <SectionHeader><b>Recipe Development and Theme Meal: </b>Thai Food</SectionHeader>
    ...
    <P align='center' style={{ paddingTop: '0.8rem' }}><i>Liang, M. (December 2018)</i></P>
    <br />
    <SubHeader>Project Goals</SubHeader>
    <SectionContainer>
      <P>The goal of this project is to test and develop a <b>new plant-forward recipe</b> to replace the beef stew on the patient menu for that day in both hospitals. This dish needs to <i>spread to at least 5 core menu</i> and provide at least <i>2.45 mg of iron</i> and <i>10-15 grams of protein</i>.</P>
    </SectionContainer>
    <br />
    <SubHeader>The Process</SubHeader>
    <ol>
      <li><P>Choose a theme to start developing recipe ideas. </P></li>
      <li><P>Begin recipe development with Executive Chefs in the kitchen and test modifications if necessary.</P></li>
      <li><P>Create menu announcement graphics and format for patient menus and determine marketing strategies for the menu.</P></li>
      <li><P>Create, standardize, and analyze recipes in software Computrition.</P></li>
      <li><P>Determine the plating presentation of food and take photos of the final plate presentation. </P></li>
      <li><P>Create plan-o-gram for trayline set up in both hospitals.</P> </li>
      <li><P>Conduct a task force meeting to share theme meal with the team and discuss the execution and supervision plan.</P> </li>
      <li><P>On the day of, huddle with the assembly and patient food service supervisors to review plating.</P> </li>
      <li><P>Conduct plate waste study for the main menu item.</P> </li>
      <li><P>Calculate full-time equivalents used for theme meal and compare with usual production, compare the contribution analysis to the average of three previous default entreés.</P> </li>
      <li><P>Present theme meal outcome, survey results, contribution analysis, and cost to UCSF’s food service management team. </P> </li>
    </ol>
    <br />
    <SubHeader>The Result</SubHeader>
    ...
    <SubHeader>Final Thoughts</SubHeader>
    <SectionContainer>
      <P>This project was exceptionally fun to work on. Coming up with unique and vibrant recipes that patients would enjoy was a great way to learn all the intricate steps that are required to develop and test a recipe that has multiple requirements and restrictions. The hardest part of this project was to actually choose one of the multiple recipes we tested as the main entrée since they were all delicious.</P>
    </SectionContainer>
    <Divider />
